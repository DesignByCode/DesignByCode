        ...
        public function run(): void
        {
            $patterns = [
                ...
                [
                    "name" => "Hexagon",
                    "premium" => false,
                    "snippet" => '<svg class="dbc-svg" xmlns="http://www.w3.org/2000/svg" width="100%" height="100%"><pattern id="dbc-[random]" width="272.72" height="473.27" x="0" y="0" patternUnits="userSpaceOnUse" patternTransform="rotate(0) skewX(0) scale(0.2)" viewBox="0 0 272.72 473.27"><g id="dbc-p-[random]"><path fill="currentColor" stroke="none" opacity="1" d="M272.72 473.27V340.15L146.36 267.2V120.83l126.36-72.95V0h-10v30.56l-126.36 72.95L10 30.56V0H0v47.88l126.36 72.95V267.2L0 340.15v133.12h10v-115.8l126.36-72.95 126.36 72.95v115.8h10z"/></g><use x="0" y="0" href="#dbc-p-[random]"/></pattern><rect width="100%" height="100%" fill="url(#dbc-[random])"/></svg>'
                ],
                [
                    "name" => "Triangle stack",
                    "premium" => false,
                    "snippet" => '<svg class="dbc-svg" xmlns="http://www.w3.org/2000/svg" width="100%" height="100%"><pattern id="dbc-[random]" width="296" height="174" x="0" y="0" patternUnits="userSpaceOnUse" patternTransform="rotate(0) skewX(0) scale(0.4)" viewBox="0 0 296 174"><g id="dbc-p-[random]"><path fill="currentColor" stroke="none" opacity="1" d="M286 174h10V0h-10v17.46L255.76 0h-40l61.58 35.56L158 104.46V0h-20v104.46L18.66 35.56 80.24 0h-40L10 17.46V0H0v174h10V53.65l119.34 68.91L40.24 174h40L138 140.65V174h20v-33.35L215.76 174h40l-89.1-51.44L286 53.65V174z"/></g><use x="0" y="0" href="#dbc-p-[random]"/></pattern><rect width="100%" height="100%" fill="url(#dbc-[random])"/></svg>'
                ],
            ];
